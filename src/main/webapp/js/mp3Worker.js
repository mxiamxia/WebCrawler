...
self.onmessage = function(e) {
	...
	case 'init':
		...
		Lame.set_in_samplerate(mp3codec, e.data.config.samplerate || 16000);
		Lame.set_out_samplerate(mp3codec, e.data.config.samplerate || 16000);
		Lame.set_bitrate(mp3codec, e.data.config.bitrate || 16);
